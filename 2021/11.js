...
export default function shouldBuyFidelity(times) {
    ...
    for (let i = 0; i < times; i++) {
        discount *= 0.75;
        fidelityPrice += 12 * discount;
    }

    return fidelityPrice < normalPrice;
}

const shouldBuyFidelity1 = shouldBuyFidelity(1);
console.log(shouldBuyFidelity1); // false -> Mejor comprar tickets de un sólo uso

const shouldBuyFidelity2 = shouldBuyFidelity(3);
console.log(shouldBuyFidelity2); // false -> Mejor comprar tickets de un sólo uso

const shouldBuyFidelity3 = shouldBuyFidelity(100);
console.log(shouldBuyFidelity3); // true -> Mejor comprar tarjeta fidelidad
